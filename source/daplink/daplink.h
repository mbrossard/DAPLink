...
#if (DAPLINK_ROM_IF_START < DAPLINK_ROM_CONFIG_USER_START)
...
#else
COMPILER_ASSERT(DAPLINK_ROM_CONFIG_USER_START + DAPLINK_ROM_CONFIG_USER_SIZE == DAPLINK_ROM_IF_START);
COMPILER_ASSERT(DAPLINK_ROM_IF_START + DAPLINK_ROM_IF_SIZE == DAPLINK_ROM_START + DAPLINK_ROM_SIZE);
#endif
...
#define DAPLINK_HIC_ID_STM32F4X1CE  0x9796990E // reserving for future use
#define DAPLINK_HIC_ID_STM32F429XX  0x9796990F
#define DAPLINK_HIC_ID_STM32F746XX  0x97969910
...
#define DAPLINK_HIC_ID_STM32H743XX  0x97969940
