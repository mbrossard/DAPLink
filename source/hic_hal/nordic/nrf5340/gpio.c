/**
 * @file    gpio.c
 * @brief   GPIO access functions for nrf5340 HIC
 *
...
void gpio_init(void)
{
    ...
    nrf_gpio_pin_write(LED_PWR, GPIO_LED_STATE(0));
#endif
#ifdef LED_CONNECTED
    ...
    nrf_gpio_cfg_input(RESET_BUTTON, NRF_GPIO_PIN_PULLUP);
}
