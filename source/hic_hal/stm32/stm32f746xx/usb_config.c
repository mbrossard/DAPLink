...
#if (MSC_ENDPOINT)
#define USBD_MSC_EP_BULKIN          (USBD_HID_EP_ALLOCATED + 1)
#define USBD_MSC_EP_BULKOUT         (USBD_HID_EP_ALLOCATED + 1)
#define USBD_MSC_EP_ALLOCATED       (USBD_HID_EP_ALLOCATED + 1)
#else
#define USBD_MSC_EP_BULKIN          0
#define USBD_MSC_EP_BULKOUT         0
#define USBD_MSC_EP_ALLOCATED       USBD_HID_EP_ALLOCATED
#endif
#define USBD_MSC_EP_BULKIN_STACK    0
#define USBD_MSC_WMAXPACKETSIZE     64
#define USBD_MSC_HS_ENABLE          USBD_HS_ENABLE
...
#if (CDC_ENDPOINT)
#define USBD_CDC_ACM_EP_INTIN           (USBD_MSC_EP_ALLOCATED + 1)
#define USBD_CDC_ACM_EP_BULKIN          (USBD_MSC_EP_ALLOCATED + 2)
#define USBD_CDC_ACM_EP_BULKOUT         (USBD_MSC_EP_ALLOCATED + 2)
#define USBD_CDC_ACM_EP_ALLOCATED       (USBD_MSC_EP_ALLOCATED + 2)
#else
#define USBD_CDC_ACM_EP_INTIN           0
#define USBD_CDC_ACM_EP_BULKIN          0
#define USBD_CDC_ACM_EP_BULKOUT         0
#define USBD_CDC_ACM_EP_ALLOCATED       USBD_MSC_EP_ALLOCATED
#endif
...
#if (((USBD_CDC_ACM_HS_ENABLE1) && (USBD_CDC_ACM_SENDBUF_SIZE    < USBD_CDC_ACM_HS_WMAXPACKETSIZE1)) || \
     (USBD_CDC_ACM_SENDBUF_SIZE    < USBD_CDC_ACM_WMAXPACKETSIZE1))
#error "Send Buffer size must be larger or equal to Bulk In maximum packet size!"
#endif
#if (((USBD_CDC_ACM_HS_ENABLE1) && (USBD_CDC_ACM_RECEIVEBUF_SIZE < USBD_CDC_ACM_HS_WMAXPACKETSIZE1)) || \
...
#define USBD_WEBUSB_LANDING_URL     "daplink.io"
#define USBD_WEBUSB_ORIGIN_URL      "daplink.io"
...
#if (BULK_ENDPOINT)
#define USBD_BULK_EP_BULKIN          (USBD_CDC_ACM_EP_ALLOCATED + 1)
#define USBD_BULK_EP_BULKOUT         (USBD_CDC_ACM_EP_ALLOCATED + 1)
#define USBD_BULK_EP_ALLOCATED       (USBD_CDC_ACM_EP_ALLOCATED + 1)
#else
#define USBD_BULK_EP_BULKIN          0
#define USBD_BULK_EP_BULKOUT         0
#define USBD_BULK_EP_ALLOCATED       USBD_CDC_ACM_EP_ALLOCATED
#endif
#define USBD_BULK_WMAXPACKETSIZE     64
#define USBD_BULK_HS_ENABLE          USBD_HS_ENABLE
#define USBD_BULK_HS_WMAXPACKETSIZE  512
#define USBD_BULK_STRDESC            L"CMSIS-DAP v2"

// #define USBD_BULK_EP_BULKIN_SWO

/* USB Device Calculations ---------------------------------------------------*/

#define USBD_IF_NUM_MAX             (USBD_BULK_ENABLE + USBD_WEBUSB_ENABLE + USBD_HID_ENABLE + \
                                     USBD_MSC_ENABLE + (USBD_CDC_ACM_ENABLE * 2) + USBD_CLS_ENABLE)
#define USBD_MULTI_IF               (USBD_CDC_ACM_ENABLE * (USBD_HID_ENABLE |USBD_MSC_ENABLE | USBD_CLS_ENABLE | \
                                                            USBD_WEBUSB_ENABLE | USBD_BULK_ENABLE))
#define USBD_EP_NUM_CALC_HID        (USBD_HID_ENABLE * MAX(USBD_HID_EP_INTIN, USBD_HID_EP_INTOUT))
#define USBD_EP_NUM_CALC_MSC        (USBD_MSC_ENABLE * MAX(USBD_MSC_EP_BULKIN, USBD_MSC_EP_BULKOUT))
#define USBD_EP_NUM_CALC_CDC0       MAX(USBD_CDC_ACM_EP_BULKIN, USBD_CDC_ACM_EP_BULKOUT)
#define USBD_EP_NUM_CALC_CDC        (USBD_CDC_ACM_ENABLE * MAX(USBD_CDC_ACM_EP_INTIN, USBD_EP_NUM_CALC_CDC0))
#define USBD_EP_NUM_CALC_BULK       (USBD_BULK_ENABLE * MAX(USBD_BULK_EP_BULKIN, USBD_BULK_EP_BULKOUT))
#define USBD_EP_NUM_CALC0           MAX(USBD_EP_NUM_CALC_HID, USBD_EP_NUM_CALC_MSC)
#define USBD_EP_NUM_CALC1           MAX(USBD_EP_NUM_CALC_CDC, USBD_EP_NUM_CALC_BULK)
#define USBD_EP_NUM                 MAX(USBD_EP_NUM_CALC0, USBD_EP_NUM_CALC1)
...
#define USBD_CDC_ACM_CIF_STR_NUM   (3+USBD_STRDESC_SER_ENABLE+0)
#define USBD_CDC_ACM_DIF_STR_NUM   (3+USBD_STRDESC_SER_ENABLE+1)
#define USBD_HID_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_CDC_ACM_ENABLE*2)
#define USBD_WEBUSB_IF_STR_NUM     (3+USBD_STRDESC_SER_ENABLE+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE)
#define USBD_MSC_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_WEBUSB_ENABLE)
#define USBD_BULK_IF_STR_NUM       (3+USBD_STRDESC_SER_ENABLE+USBD_CDC_ACM_ENABLE*2+USBD_HID_ENABLE+USBD_WEBUSB_ENABLE+USBD_MSC_ENABLE)

#if    (USBD_HID_ENABLE)
#if    (USBD_HID_HS_ENABLE)
#define USBD_HID_MAX_PACKET        MAX(USBD_HID_HS_WMAXPACKETSIZE, USBD_HID_WMAXPACKETSIZE)
#else
#define USBD_HID_MAX_PACKET        (USBD_HID_WMAXPACKETSIZE)
#endif
#define USBD_HID_FIFO_SIZE         USBD_HID_MAX_PACKET,
#else
#define USBD_HID_MAX_PACKET        0
#define USBD_HID_FIFO_SIZE
#endif
#if    (USBD_MSC_ENABLE)
#if    (USBD_MSC_HS_ENABLE)
#define USBD_MSC_MAX_PACKET        MAX(USBD_MSC_HS_WMAXPACKETSIZE, USBD_MSC_WMAXPACKETSIZE)
#else
#define USBD_MSC_MAX_PACKET        USBD_MSC_WMAXPACKETSIZE
#endif
#define USBD_MSC_FIFO_SIZE         USBD_MSC_MAX_PACKET,
#else
#define USBD_MSC_MAX_PACKET        0
#define USBD_MSC_FIFO_SIZE
#endif
#if    (USBD_CDC_ACM_ENABLE)
#if    (USBD_CDC_ACM_HS_ENABLE)
#define USBD_CDC_ACM_MAX_PACKET    MAX(USBD_CDC_ACM_HS_WMAXPACKETSIZE, USBD_CDC_ACM_WMAXPACKETSIZE)
#else
#define USBD_CDC_ACM_MAX_PACKET    USBD_CDC_ACM_WMAXPACKETSIZE
#endif
#if    (USBD_CDC_ACM_HS_ENABLE1)
#define USBD_CDC_ACM_MAX_PACKET1   MAX(USBD_CDC_ACM_HS_WMAXPACKETSIZE1, USBD_CDC_ACM_WMAXPACKETSIZE1)
#else
#define USBD_CDC_ACM_MAX_PACKET1   USBD_CDC_ACM_WMAXPACKETSIZE1
#endif
#define USBD_CDC_ACM_FIFO_SIZE     USBD_CDC_ACM_MAX_PACKET,
#define USBD_CDC_ACM_FIFO_SIZE1    USBD_CDC_ACM_MAX_PACKET1,
#else
#define USBD_CDC_ACM_MAX_PACKET    0
#define USBD_CDC_ACM_MAX_PACKET1   0
#define USBD_CDC_ACM_FIFO_SIZE
#define USBD_CDC_ACM_FIFO_SIZE1
#endif
#if    (USBD_BULK_ENABLE)
#if    (USBD_BULK_HS_ENABLE)
#define USBD_BULK_MAX_PACKET       MAX(USBD_BULK_HS_WMAXPACKETSIZE, USBD_BULK_WMAXPACKETSIZE)
#else
#define USBD_BULK_MAX_PACKET       USBD_BULK_WMAXPACKETSIZE
#endif
#define USBD_BULK_FIFO_SIZE        USBD_BULK_MAX_PACKET,
#else
#define USBD_BULK_MAX_PACKET       0
#define USBD_BULK_FIFO_SIZE
#endif

#define USBD_FIFO_SIZE_LIST \
       USBD_MAX_PACKET0, \
       USBD_HID_FIFO_SIZE \
       USBD_MSC_FIFO_SIZE \
       USBD_CDC_ACM_FIFO_SIZE \
       USBD_CDC_ACM_FIFO_SIZE1 \
       USBD_BULK_FIFO_SIZE

#define USBD_FIFO_SIZE_SUM \
       USBD_MAX_PACKET0 + \
       USBD_HID_MAX_PACKET + \
       USBD_MSC_MAX_PACKET + \
       USBD_CDC_ACM_MAX_PACKET + \
       USBD_CDC_ACM_MAX_PACKET1 + \
       USBD_BULK_MAX_PACKET
