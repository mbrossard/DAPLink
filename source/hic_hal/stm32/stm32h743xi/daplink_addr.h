...
#define DAPLINK_ROM_SIZE                0x00060000 // Limit to 384 KB

#define DAPLINK_RAM_START               0x24000000
#define DAPLINK_RAM_SIZE                0x00040000 // Limit to 256 KB

/* ROM sizes */

#define DAPLINK_ROM_BL_START            0x08000000
#define DAPLINK_ROM_BL_SIZE             0x00020000 // 128 KB bootloader

#define DAPLINK_ROM_IF_START            0x08020000
#define DAPLINK_ROM_IF_SIZE             0x00020000

#define DAPLINK_ROM_CONFIG_USER_START   0x08040000
#define DAPLINK_ROM_CONFIG_USER_SIZE    0x00020000

/* RAM sizes */

#define DAPLINK_RAM_APP_START           0x24000000
#define DAPLINK_RAM_APP_SIZE            0x0003FF00

#define DAPLINK_RAM_SHARED_START        0x2403FF00
#define DAPLINK_RAM_SHARED_SIZE         0x00000100

/* Flash Programming Info */

#define DAPLINK_SECTOR_SIZE             0x00020000 // 128 KB
